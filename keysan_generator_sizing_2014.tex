...
However, the cost of these devices are higher than the onshore equivalents. The cost of the power take-off system can be reduced by reducing power rating of the generator, which will increase the capacity factor. Annual energy income is estimated with different sized generators in an oscillating water column array. The parameters used in mechanical and electrical models are presented in the paper as a function of the power rating.
\end{abstract}
...
\begin{figure}[t!]
  \centering
  \subfloat[Magnetising inductance, $L_m$.]{\label{Lm_plot}\includegraphics[width=0.5\textwidth]{Lm_plot}}
